    ...
    <section class="content">
        ...
        <table>
            ...
            <c:forEach var="clientes" items="${clientes}">
                <c:if test="${clientes.isAtivo}">
                    <tr>
                        <td>${clientes.id}</td>
                        <td>${clientes.nome}</td>
                        <td><a href="/app/cliente/verCliente?id=${clientes.id}"><img src="<c:url value="/assets/edit.png"/>"  class="icon-edit" alt="lápis preto">Editar</a></td>
                    </tr>
                </c:if>
            </c:forEach>
        </table>
        ...
        <div class="popup">
            <div class="conteudo">
                ...
                <h3>Novo produto</h3>
                <form action="/app/cliente/cadastrar" method="post">
                    <div>
